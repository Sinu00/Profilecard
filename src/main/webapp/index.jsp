...
<form class="form" action="loginvalidation" method="post">
  ...
  <div class="login-with">
    ...
    <div class="button-container">
        ...
        <a class="button-confirm" href="signup.jsp"> Sign Up →</a>
    </div>
</form>
</body>
</html>
